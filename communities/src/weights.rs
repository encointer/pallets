...
//! Autogenerated weights for pallet_encointer_communities with reference hardware:
//! * Core(TM) i7-10875H
//! * 32GB of RAM
//! * NVMe SSD
//!
...
/// Weight functions needed for pallet_encointer_communities.
...
impl WeightInfo for () {
	...
	fn set_min_solar_trip_time_s() -> Weight {
		Weight::from_parts(16_300_000, 0).saturating_add(RocksDbWeight::get().writes(1))
	}
	fn set_max_speed_mps() -> Weight {
		Weight::from_parts(15_500_000, 0).saturating_add(RocksDbWeight::get().writes(1))
	}
	fn purge_community() -> Weight {
		Weight::from_parts(18_355_700_000, 0)
